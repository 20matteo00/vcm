            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active"
                        href="index.php?page=competizioni&com=0"><b><?php echo $VCM_comp_in_progress; ?></b></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active"
                        href="index.php?page=competizioni&com=1"><b><?php echo $VCM_comp_finished; ?></b></a>
                </li>
...
<!--                 <li class="nav-item">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex d-flex align-items-center">
                    <!-- Cambio lingua -->
                    <div class="dropdown">
                        <button class="btn btn-link dropdown-toggle px-0 fw-bold" type="button" id="languageDropdown"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo $VCM_language; ?>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                            <li><a class="dropdown-item"
                                    href="index.php?page=azioni&lang=it&url=<?php echo urlencode($currentUrl); ?>"><?php echo $VCM_italian; ?></a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="index.php?page=azioni&lang=en&url=<?php echo urlencode($currentUrl); ?>""><?php echo $VCM_english; ?></a>
                            </li>
