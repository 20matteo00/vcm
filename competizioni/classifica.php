...
function campionato($conn, $user, $name, $tablepartite, $tablestatistiche)
{
    ...
    foreach ($statistiche as $squadra => $stats) {
        $sql_statistiche = "INSERT INTO $tablestatistiche (utente, nome, squadra, vinte_casa, pari_casa, perse_casa, fatti_casa, subiti_casa, vinte_trasferta, pari_trasferta, perse_trasferta, fatti_trasferta, subiti_trasferta) 
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
