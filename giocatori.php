...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="alert alert-success mt-3">
            <?php echo $_SESSION['success_message']; unset($_SESSION['success_message']); ?></div>
        <?php endif; ?>
        <!-- Messaggio di errore -->
        <?php if (isset($_SESSION['error_message'])) : ?>
        <div class="alert alert-danger mt-3">
            <?php echo $_SESSION['error_message']; unset($_SESSION['error_message']); ?></div>
        <?php endif; ?>
        <form action="#" method="post" class="mt-4">
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-2 text-center">
                    <div class="mb-3">
                        <label for="<?php echo $VCM_strength; ?>"
                            class="form-label"><?php echo $VCM_strength; ?></label>
                ...
                <div class="col-lg-2 text-center">
                    <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-success w-100 mt-4"
                            name="submit"><?php echo $VCM_add; ?></button>
                    </div>
                </div>
            </div>
        </form>
                ...
                <table class="table table-bordered text-center table-responsive miatable" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td>
                                <div class="miocolore px-2"
                                    style="background-color: <?php echo htmlspecialchars($row['colore1']); ?>; color: <?php echo htmlspecialchars($row['colore2']); ?>;">
                                    <?php echo htmlspecialchars($row['nome']); ?>
                                </div>
                            </td>
                            <td><?php echo htmlspecialchars($row['forza']); ?></td>
                            <td>
                                <a href="index.php?page=azioni&name=modificasquadra&squadra=<?php echo $row['nome']; ?>"
                                    class="btn btn-warning"><?php echo $VCM_edit; ?></a>
                                <a href="index.php?page=azioni&name=eliminasquadra&squadra=<?php echo $row['nome']; ?>"
